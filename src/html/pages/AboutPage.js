...
export default class AboutPage extends React.Component {
  render() {
    return (
      <Page title="About Us">
        <div className="Page-content u-trumpetBackground">
          <div className="Page-section">
            <h2 className="Page-sectionTitle">Background</h2>
          ...
          <div className="Page-section">
            <h2 className="Page-sectionTitle">Mission Statement</h2>
          ...
          <div className="Page-section">
            <h2 className="Page-sectionTitle">Value Proposition</h2>
